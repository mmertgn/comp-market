...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="<?= base_url()?>admin/kategoriler/katguncellekaydet/<?= $kategoriler[0]->id ?>" method="post">
                <fieldset>
                    <div class="control-group">
                        <label class="control-label" for="typeahead">Kategori Adı </label>
                        <div class="controls">
                            <input type="text" class="span6" name="kat_adi" value="<?= $kategoriler[0]->kat_adi ?>">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead">Kategori Açıklaması </label> <div class="controls">
                            <input type="text" class="span6" name="kat_aciklama" value="<?= $kategoriler[0]->kat_aciklama ?>">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead">Kategori Keywords </label>
                        <div class="controls">
                            <input type="text" class="span6" name="kat_keywords" value="<?= $kategoriler[0]->kat_keywords ?>">
                        </div>
                    </div>
